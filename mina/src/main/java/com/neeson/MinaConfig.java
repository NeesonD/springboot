...
import com.neeson.Filter.HeartBeatFilter;
import com.neeson.Handler.ServerHandler;
...
public class MinaConfig {
    ...
    @Bean
    public InetSocketAddress inetSocketAddress(){return new InetSocketAddress(PORT);}
